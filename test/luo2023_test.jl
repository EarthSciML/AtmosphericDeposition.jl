@testsnippet Luo2023Setup begin
    ...
    using AtmosphericDeposition: turbulence_velocity, cloudy_air_refreshing_rate,
        grid_refreshing_time, air_refreshing_limited_rate, hno3_uptake_efficiency,
        cloud_ice_uptake_rate, air_refreshing_limited_ice_uptake_rate,
        cold_cloud_rainout_efficiency,
        T_upper_luo, T_lower_luo, γ_base, γ_delta, zero_dimless, one_dimless,
...
@testitem "Eq. 14 - Cloud ice uptake rate" setup=[Luo2023Setup] tags=[:luo2023] begin
    ...
    vals = merge(const_defaults, Dict(
